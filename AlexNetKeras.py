for it in range(1,11):
  ...
  experiment = Experiment(api_key="9F7edG4BHTWFJJetI2XctSUzM",
                          project_name="alex-net-tess-dataset-5c-global-mean", workspace="lukkascost")
  ...
  X_train, X_test, y_train, y_test = train_test_split(atts, labels, train_size=560,test_size=145, random_state=42, stratify=strate)
